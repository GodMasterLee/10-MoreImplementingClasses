...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.h_rect_upper_left_x = intersection_center.x - width / 2
        self.h_rect_upper_left_y = intersection_center.y - letter_thickness / 2
        self.h_rect_lower_right_x = intersection_center.x + width / 2
        self.h_rect_lower_right_y = intersection_center.y + letter_thickness / 2

        self.h_rect = rg.Rectangle(rg.Point(self.h_rect_upper_left_x,self.h_rect_upper_left_y),rg.Point(self.h_rect_lower_right_x,self.h_rect_lower_right_y))

        self.v_rect_upper_left_x = intersection_center.x - letter_thickness / 2
        self.v_rect_upper_left_y = intersection_center.y - letter_thickness / 2
        self.v_rect_lower_right_x = intersection_center.x + letter_thickness / 2
        self.v_rect_lower_right_y = intersection_center.y + height - letter_thickness / 2

        self.v_rect = rg.Rectangle(rg.Point(self.v_rect_upper_left_x,self.v_rect_upper_left_y),rg.Point(self.v_rect_lower_right_x,self.v_rect_lower_right_y))
